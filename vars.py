...
FROM_GRP = [int(channel_id) for channel_id in environ.get('FROM_GRP', '-1001232792540 -1001288657204 -1002629654353 -1001600059209').split() if re.match(r'^-?\d+$', channel_id)]
