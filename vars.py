...
FROM_GRP = [int(channel_id) for channel_id in environ.get('FROM_GRP', '-1002065410848 -1003210076659 -1001955482312 -1001971491129 -1001994209101').split() if re.match(r'^-?\d+$', channel_id)]
