...
FROM_GRP = [int(channel_id) for channel_id in environ.get('FROM_GRP', '-1001600059209 -1001232792540 -1002005238353 -1001588577224').split() if re.match(r'^-?\d+$', channel_id)]
